"""Train ResNet18-1D-XRF55-Amp — multi-protocol, multi-seed, resume-safe.
...
Usage:
    cd har_csi
    python baselines/resnet1d_xrf55_amp/trainer.py --protocol split --n_seeds 1
    python baselines/resnet1d_xrf55_amp/trainer.py --protocol loso  --n_seeds 3
"""
import sys
...
from baselines.resnet1d_xrf55_amp.dataset import (
...
OUTPUT_DIR = PROJECT_ROOT / 'outputs' / 'runs' / 'resnet1d_xrf55_amp'
